  ...
  App.dashboard = function( ){
    ...
    //Donut Chart
      ...
      var color3 = App.color.primary;
  	  ...
  	  Morris.Donut({
          ...
          {label: '21-30', value: 10},
          {label: '31-40', value: 15},
          {label: '41-50', value: 5},
          {label: '51-60', value: 10},
          {label: '61-70', value: 15},
          {label: '71-80', value: 40},
          {label: '81-90', value: 10},
    ...
    function mainChart(){
      ...
      }],
      {
        ...
        colors: [color1, color2, color3],
        xaxis: {
          tickFormatter: function(label, index, labels){
            return '';
          },
          autoscaleMargin: 0,
          ticks: 11,
